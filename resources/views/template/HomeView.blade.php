...
<body>
    ...
    <header id="header" class="d-flex align-items-center">
        <div class="container d-flex align-items-center">
            ...
            <h1 class="logo me-auto"><a href="{{ route('home') }}">SIPENJAMU</a></h1>
    ...
    <footer id="footer">
        <div class="container">
            <div class="copyright">
                &copy; Copyright <strong><span>SIPENJAMU</span></strong>. All Rights Reserved
            </div>
            <div class="credits">
                Created by <a href="https://rickyginting.github.io/">Basukarno</a>
            </div>
        </div>
    </footer>
    <!-- End Footer -->
