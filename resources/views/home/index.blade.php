            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="carousel-item active" style="background-image: url({{ asset('home/img/slide/slide-1.jpg') }})">
                    <div class="carousel-container">
                        <div class="container">
                            <h2 class="animate__animated animate__fadeInDown">SIPENJAMU</h2>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6 order-1 order-lg-2">
                        <img src="{{ asset('home/img/about2.jpg') }}" class="img-fluid" alt="">
                    </div>
                    <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
                        <h3>Data Program Studi Terdaftar Pada Sistem.</h3>
                        <p class="fst-italic">
                            Berikut adalah data Program Studi yang terdaftar pada SIPENJAMU di Kampus <b>Universitas Wijaya Putra</b>
                        </p>
                        <ul>
                            @foreach ($data['p'] as $i)
